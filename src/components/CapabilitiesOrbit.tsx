...
const PANELS: Panel[] = [
  ...
  },
  {
    ...
    headline: "Devices that connect, update, and run on their own.",
    line: "Purpose-built connected systems for field and edge deployment. We design firmware, cloud sync, and OTA management so devices stay current and accessible without manual intervention.",
    bullets: [
      "Raspberry Pi and embedded controllers for edge deployment",
      "MQTT telemetry, cloud sync, and remote device management",
      "Secure connectivity, versioned OTA updates, and fleet rollback",
    ],
